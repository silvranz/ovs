...
<div class="left-content" id="add-content" style="display:none;">
	<div class="content">
		...
		<div class="category-content" id="text-panel">
			...
			<div class="category-view">
				<div class="draggable-element" element-type="text">
					<h1>Site Title</h1>
				</div>
				<div class="draggable-element" element-type="text">
					<h1>Site Title</h1>
...
<div id="editor-container">
	...
	<div id="editor-workspace">
		<div id="editor-header" class="editor-workspace editor-header">
			<div class="editor-header-separator editor-content-separator top-point"></div>
		</div>
		<div id="editor-content" class="editor-workspace editor-content">
		</div>
		<div id="editor-footer" class="editor-workspace editor-footer">
			<div class="editor-footer-separator editor-content-separator bottom-point"></div>
		</div>

		<!-- Preview Workspace -->
			<div class="enlarge-preview-workspace"></div>
	</div>
</div>
<!-- End Document
	–––––––––––––––––––––––––––––––––––––––––––––––––– -->

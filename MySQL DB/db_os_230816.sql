...
insert  into `store`(`StoreID`,`StoreName`,`StoreDomain`,`StoreImage`,`StoreProjectName`,`UserID`,`TemplateID`,`StoreJson`,`CreatedUser`,`CreatedDate`,`AuditedActivity`,`AuditedUser`,`AuditedTime`) values (1,'Thelana Shop','thelana','aa.jpg','thelana',5,1,NULL,5,'2016-08-23 14:33:07','C',NULL,NULL);

...
insert  into `generateweblog`(`GenerateWebID`,`StoreID`,`TemplateID`,`SPName`,`UserID`,`GenerateDate`,`Browser`,`BrowserVersion`,`IPAddress`,`Device`,`OS`,`CreatedUser`,`CreatedDate`,`AuditedActivity`,`AuditedUser`,`AuditedTime`) values (1,1,1,'GenerateTableCompanyProfile',1,'2016-08-10 12:13:23','Chrome','10','10.1.11.11','Windows','Windows 10',1,'2016-08-10 12:13:23','C',NULL,NULL),(2,17,3,'GenerateTableCompanyProfile',3,'2016-08-17 09:51:28','Mozilla','5.0 (Windows)','::1','pc','Win32',3,'2016-08-17 09:51:28','C',NULL,NULL);
